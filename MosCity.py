...
my_url = "http://www.moscow_city.vybory.izbirkom.ru/region/moscow_city?action=show&vrn=27720002197402&region=77&prver=0&pronetvd=null"
...
#export to .csv
result.to_csv("UIKsMoscow.csv", sep=';', encoding='utf-8')